...
model = sm.tsa.arima.ARIMA(arimaData, order=(3,3,3))
...
tshUp = pd.DataFrame(tshVecup.T, index=dateVec[forecastWindow + step:len(
    dataFrame)])  # building the DataFrame with both thresholds
