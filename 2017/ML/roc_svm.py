def resultsL(path):
    ...
    dataset = []
    wb = Workbook()
    wb.save(filename="C:/Users/joao.teles/projects/DDoS_Detection/2017/ML/roc/roc_svmL.xlsx")
    std = wb['Sheet']
    wb.remove(std)
    with open(path) as f:
        lines = f.readlines()
    ...
    for i in range(0,len(splited_test)):
        ...
        with pd.ExcelWriter('C:/Users/joao.teles/projects/DDoS_Detection/2017/ML/roc/roc_svmL.xlsx',mode='a') as writer:
...
def resultsR(path):
    ...
    dataset = []
    wb = Workbook()
    wb.save(filename="C:/Users/joao.teles/projects/DDoS_Detection/2017/ML/roc/roc_svmR.xlsx")
    std = wb['Sheet']
    wb.remove(std)
    with open(path) as f:
        lines = f.readlines()
    ...
    for i in range(0,len(splited_test)):
        ...
        dfvec.append(pd.DataFrame(splited_test[i], columns=['Time(s)', 'C','Gamma', 'Quant. de Ataques',
                                            'Quant. de Ataques', 'Quant. Ataques Total', 'Acertos', 'Verd-Pos',
                                            'Verd-Neg', 'Erros', 'Falso-Pos', 'Falso-Neg', 'Taxa de Acertos']))
        with pd.ExcelWriter('C:/Users/joao.teles/projects/DDoS_Detection/2017/ML/roc/roc_svmR.xlsx',mode='a') as writer:
            dfvec[i].to_excel(writer, sheet_name=test_name)
...
def resultsP(path):
    ...
    dataset = []
    wb = Workbook()
    wb.save(filename="C:/Users/joao.teles/projects/DDoS_Detection/2017/ML/roc/roc_svmP.xlsx")
    std = wb['Sheet']
    wb.remove(std)
    with open(path) as f:
        lines = f.readlines()
    ...
    for i in range(0,len(splited_test)):
        ...
        dfvec.append(pd.DataFrame(splited_test[i], columns=['Time(s)', 'C','Degree', 'Quant. de Ataques',
                                            'Quant. de Ataques', 'Quant. Ataques Total', 'Acertos', 'Verd-Pos',
                                            'Verd-Neg', 'Erros', 'Falso-Pos', 'Falso-Neg', 'Taxa de Acertos']))
        with pd.ExcelWriter('C:/Users/joao.teles/projects/DDoS_Detection/2017/ML/roc/roc_svmP.xlsx',mode='a') as writer:
            dfvec[i].to_excel(writer, sheet_name=test_name)

resultsL('C:/Users/joao.teles/projects/DDoS_Detection/2017/ML/results/SVMresultsL.txt')
resultsR('C:/Users/joao.teles/projects/DDoS_Detection/2017/ML/results/SVMresultsR.txt')
resultsP('C:/Users/joao.teles/projects/DDoS_Detection/2017/ML/results/SVMresultsP.txt')